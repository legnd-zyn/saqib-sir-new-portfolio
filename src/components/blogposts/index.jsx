    ...
    return (
        ...
        <section className='relative w-full max-w-screen-xl mx-auto px-5 lg:px-10 pt-5 mt-10 flex items-center flex-col bg-zinc-100'>
            <div className='max-w-lg text-center'>
                <p className='text-gray-700 text-2xl lg:text-3xl font-bold bottom-line relative'>Our Blogs</p>
                <p className='text-gray-800 text-4xl lg:text-6xl font-bold px-5'>Our recent work experience</p>
            </div>
            <div className='w-full max-w-4xl mt-5'>
                ...
                <div className='w-full flex justify-center my-5'>
                    <Link href="/articles">
                        <button className='w-full max-w-[200px] px-6 lg:px-7 text-lg font-bold text-gray-700 py-1 pt-2 border-2 border-gray-400 rounded-md active:scale-95 transition-all animated-btn hover:-translate-x-1 hover:-translate-y-1 active:translate-x-0 active:translate-y-0'>See All</button>
                    </Link>
                </div>
            </div>
        </section>
